...
// -----------------------------------------------------------------------------
class simple_html_dom_original {
    public $root = null;
    public $nodes = array();
...
class simple_html_dom extends simple_html_dom_original{
	...
	function load($str, $lowercase=true) {
		if( $this->internal_encoding != self::$encoding ){
			$str = mb_convert_encoding( $str, $this->internal_encoding, self::$encoding );
		}
		parent::load( $str, $lowercase );
	}
}
